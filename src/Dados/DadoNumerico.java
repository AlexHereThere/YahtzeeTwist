 ...
 */
/**
 * clase para modelar dados numericos, los dados que enseñan puntos en el
 * despliegue.
 *
 * @author ACR
 */
public final class DadoNumerico extends Dado {
    //constructor
    public DadoNumerico(int NUMERODECARAS, int x, int y, int width, int height, String[] colores) {
    ...
    public void setImagenes() {
        try {
            imagenDado = ImageIO.read(new File("Imagenes/" + color + "/" + valorCaraMostrada + ".png"));
            if (lanzable == true) {
