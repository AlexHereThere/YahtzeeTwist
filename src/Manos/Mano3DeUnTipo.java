...
/**
 *clase para modelar la mano de 3 de un tipo
 * @author ACR
 */
public class Mano3DeUnTipo extends Mano implements Manos {
    //constructor
    public Mano3DeUnTipo()
    {    
    super();
    nombre="3 DE UN TIPO";
    ...
    int numeroDeRepetidosDeDado;
        ...
        fueUsado=true;
        if(numeroDeRepetidosMax>=3)puntaje=PuntosMaxPorDados(dados);
        else puntaje=0;
